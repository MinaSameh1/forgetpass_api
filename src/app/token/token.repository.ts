...
export function findToken(
  query: FilterQuery<tokenDocuement>,
  select?: QuerySelector<tokenDocuement>,
  options?: QueryOptions<tokenDocuement>
...
export function createToken({ uid, token }: { uid: string; token: string }) {
